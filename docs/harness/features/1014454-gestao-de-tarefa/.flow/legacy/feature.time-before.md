...
Issue #1014454. Requisito aprovado por Mário Tinelli.
...
1. Como gestor, quero criar e editar uma tarefa para descrever trabalho, prioridade, datas e estimativa.
2. Como participante, quero consultar detalhe e registros para acompanhar o trabalho do projeto.
3. Como participante, quero atribuir tarefas a outro participante ativo, a mim ou deixá-las sem responsável para distribuir responsabilidades.
4. Como responsável, quero Iniciar, Pausar e Finalizar conforme a situação para representar o andamento.
5. Como gestor, quero Cancelar, Arquivar e Desarquivar nas situações permitidas para administrar o ciclo de vida.
6. Como participante, quero colaborar com comentários formatados, imagens e anexos e manter meus próprios registros.
7. Como participante, quero consultar autoria e mudanças no histórico para entender a evolução da tarefa.
8. Como gestor, quero receber aviso de edição concorrente para revisar os dados sem perder o texto digitado.
9. Como participante, quero ver tarefas, atraso e progresso no projeto para acompanhar sua entrega.
10. Como gestor, quero confirmar o impacto de remover um participante responsável para preservar os registros e retirar suas atribuições.
