...
Issue: #1014450. Versão proposta para aprovação.
...
3. Como participante, quero listar e filtrar meus projetos e consultar seus dados e participantes.
4. Como gestor, quero editar dados, participantes e papéis para manter a organização do projeto.
5. Como gestor, quero transferir a responsabilidade principal e alterar meu próprio vínculo com confirmação, preservando a continuidade da gestão.
6. Como gestor, quero arquivar e reativar projetos, mantendo os arquivados disponíveis somente para consulta.
7. Como administrador, quero consultar os projetos e papéis de uma pessoa sem receber acesso ao conteúdo desses projetos.
8. Como gestor, quero preservar vínculos de contas inativas e reconhecer sua situação.
9. Como gestor, quero confirmar a remoção de um participante responsável por tarefas, conhecendo seus efeitos sobre as atribuições.
