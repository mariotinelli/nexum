...
Prepare exatamente uma filha com título `[QA] ` seguido do título integral da Feature. Neste ramo, e somente nele, `blocked_by` é vazio e não existem relações DEV fictícias. A QA verifica a Feature completa e não aprova a decisão.
